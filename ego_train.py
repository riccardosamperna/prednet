...
if(NOISE):
    weights_file = os.path.join(WEIGHTS_DIR, 'prednet_ego_weights_wn.hdf5')  # where weights will be saved
    json_file = os.path.join(WEIGHTS_DIR, 'prednet_ego_model_wn.json')

    #Train set
    train_file = os.path.join(DATA_DIR, 'X_train_wn.hkl')
    train_sources = os.path.join(DATA_DIR, 'sources_train_wn.hkl')
else:
    weights_file = os.path.join(WEIGHTS_DIR, 'prednet_ego_weights.hdf5')  # where weights will be saved
    json_file = os.path.join(WEIGHTS_DIR, 'prednet_ego_model.json')
